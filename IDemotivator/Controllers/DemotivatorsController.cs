        ...
        public JsonResult Upload()
        {
            ...
            foreach (string file in Request.Files)
            {
                ...
                if (upload != null)
                {
                    ...
                    {
                        File = new FileDescription(@"C:\Users\oleg\Desktop\itransition\IDemotivator\IDemotivator\" + fileName),
                        PublicId = User.Identity.Name+fileName,
                        Tags = "special, for_homepage"
                    };

                    uploadResult = cloudinary.Upload(uploadParams);
                    System.IO.File.Delete(@"C:\Users\oleg\Desktop\itransition\IDemotivator\IDemotivator\" + fileName);
                }
